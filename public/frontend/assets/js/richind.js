(function ($) {
  ...
  //Accordian
  if ($(".richind-accrodion").length) {
    var accrodionGrp = $(".richind-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".richind-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".richind-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  /*-- Hover Tilt --*/
  let richindTiltElm = $('.richind-tilt');
  if (richindTiltElm.length) {
    richindTiltElm.each(function () {
      let self = $(this);
      let options = self.data('tilt-options');
      let richindTilt = self.tilt(
  ...
  function filterMasonaryLayout() {
    let richindMasonary = $('.richind-masonary');
    if (richindMasonary.length) {
      richindMasonary.isotope({
        layoutMode: "masonry"
      });
    }
    ...
    if ($(".post-filter.has-dynamic-filters-counter").length) {
      ...
      activeFilterItem.each(function () {
        ...
        var count = $(".richind-filter").find(filterElement).length;
        $(this)
          .children(".filter-text")
  ...
  function richind_stretch() {
    var i = $(window).width();
    $(".row .richind-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  function thmOwlInit() {
    // owl slider
    let richindowlCarousel = $('.richind-owl__carousel');
    if (richindowlCarousel.length) {
      richindowlCarousel.each(function () {
        let elm = $(this);
    ...
    let richindowlCarouselNav = $('.richind-owl__carousel--custom-nav');
    if (richindowlCarouselNav.length) {
      richindowlCarouselNav.each(function () {
        let elm = $(this);
  ...
  function thmTinyInit() {
    // tiny slider
    const tinyElm = document.querySelectorAll(".richind-tiny__slider");
