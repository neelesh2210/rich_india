...
<style>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" value="{{$edit_old_user->name}}" placeholder="Enter Name..." required>
                                                </div>
                                            ...
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" value="{{$edit_old_user->email}}" placeholder="Enter Email..." required readonly>
                                                </div>
                                            ...
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="state" value="{{$edit_old_user->state}}" placeholder="Enter State..." required>
                                                </div>
                                            ...
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="referrer_code" value="{{$edit_old_user->referrer_code}}" placeholder="Enter Referrer Code..." required readonly>
                                                </div>
                                            ...
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="referral_code" value="{{$edit_old_user->referral_code}}" placeholder="Enter Referral Code..." @if($edit_old_user->referral_code) readonly @endif>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="current_plan_id" class="form-control" required>
                                                        ...
                                                        @foreach (App\CPU\PlanManager::withoutTrash()->where('status',1)->get() as $plan)
                                                            <option value="{{$plan->id}}" @if($edit_old_user->userDetail->current_plan_id == $plan->id) selected @endif>{{$plan->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control" name="old_paid_payout" value="{{$edit_old_user->userDetail->old_paid_payout}}" placeholder="Enter Old Paid Payout...">
                                                </div>
                                            </div>
                                            <div class="col-md-6 form_div">
                                                <div class="form-group">
                                                    <label for="old_not_paid_payout">Old Unpaid Payout</label>
                                                    <input type="number" step="0.01" class="form-control" name="old_not_paid_payout" value="{{$edit_old_user->userDetail->old_not_paid_payout}}" placeholder="Enter Old Unpaid Payout...">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="col-md-12">
                                                <form action="{{route('admin.update.old.user',$edit_old_user->id)}}">
                                                    <div class="card-header">
    ...
    <script>
        ...
        function submit_form(){
            $.ajax({
                type: "POST",
                url: '{{route("admin.update.old.user",'')}}/{{$edit_old_user->id}}',
