                    ...
                    <div class="card card-outline card-primary mt-4">
                        ...
                        <div class="card-body p-0">
                            <div class="modal-body">
                                <form action="{{route('admin.trainings.store')}}" method="POST" class="form-example" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control" name="date_time" id="date_time" placeholder="Date Time...">
                                            </div>
                                        </div>
                                        <div class="col-md-6 form_div">
                                            <div class="form-group">
                                    ...
                                    <div class="card-footer text-center">
                                        <button type="submit" class="btn btn-outline-success mt-1 mb-1" onclick="return confirm('Are you sure you want to Save this training?');">
