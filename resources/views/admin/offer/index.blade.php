            ...
            <div class="container-fluid">
                <div class="row">
                                        ...
                                        @forelse ($offers as $key=>$offer)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <img src="{{ asset('backend/img/offers/' . $offer->image) }}"
                                                        onerror="this.onerror=null;this.src='{{ asset('backend/img/no-image.png') }}'"
                                                        style="height: 50px;width: 50px;">
                                                </td>
                                                <td class="text-center">
                                                    <form id="delete-form"
                                                        action="{{ route('admin.offers.destroy', encrypt($offer->id)) }}"
                                                        method="POST"
                    ...
                    <div class="col-4">
                        <div class="card card-outline card-primary mt-4">
                            <div class="card-header">
                                <h5 class="mb-0">Add Offer</h5>
                            </div>
                            <form action="{{ route('admin.offers.store') }}?type=sliders" method="POST"
