    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <form action="{{ route('admin.plan.store') }}" method="POST" class="form-example" enctype="multipart/form-data">
                        <div class="col-12">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach (App\Models\Admin\CommissionSetting::all() as $key => $commission_setting)
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Commission Amount for Level {{ $key + 1 }} <span class="text-danger">*</span></label>
                                                        <input type="number" step="0.01" name="commission[]" class="form-control" placeholder="Amount for Level {{ $key + 1 }}... " required>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="cosmofeed_base_price_url" class="form-control" placeholder="Cosmofeed Base Price Url">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Cosmofeed Discounted Price Url </label>
                                                    <input type="text" name="cosmofeed_discounted_price_url" class="form-control" placeholder="Cosmofeed Discounted Price Url">
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    @forelse (App\CPU\CourseManager::withoutTrash()->orderBy('name','asc')->get() as $course)
                                                        <tr>
                                                            <td class="text-center">
                                                                <input type="checkbox" name="course_ids[]" value="{{ $course->id }}" class="plan_checkboxes">
                                                            </td>
                                                            <td class="text-center">
                                ...
                                <div class="card-body p-0">
                                    <div class="modal-body">
                                        ...
                                        <div class="card-footer text-center">
                                            <button type="submit" class="btn btn-outline-success mt-1 mb-1" onclick="return confirm('Are you sure you want to Save this plan?');"><i class="fa fa-check" aria-hidden="true"></i> SAVE</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
