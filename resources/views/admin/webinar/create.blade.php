                    ...
                    <div class="card card-outline card-primary mt-4">
                        ...
                        <div class="card-body p-0">
                            <div class="modal-body">
                                <form action="{{route('admin.webinars.store')}}" method="POST" class="form-example" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="card-footer text-center">
                                        <button type="submit" class="btn btn-outline-success mt-1 mb-1" onclick="return confirm('Are you sure you want to Save this webinar?');">
