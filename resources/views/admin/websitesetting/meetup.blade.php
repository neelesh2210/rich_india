            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="card card-outline card-primary mt-4">
                            ...
                            <div class="card-body table-responsive p-2">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($meetups as $key=>$meetup)
                                            <tr>
                                                <td class="text-center">{{ $key + 1 }}</td>
                                                <td class="text-center">
                                                    <img src="{{ asset('backend/img/websitesetting/meetup/' . $meetup->content) }}" onerror="this.onerror=null;this.src='{{ asset('backend/img/no-image.png') }}'" style="height: 50px;width: 50px;">
                                                </td>
                                                <td class="text-center">
                                                    <form id="delete-form"
                                                        action="{{ route('admin.websitesetting.destroy', encrypt($meetup->id)) }}"
                                                        method="POST"
                    ...
                    <div class="col-4">
                        <div class="card card-outline card-primary mt-4">
                            <div class="card-header">
                                <h5 class="mb-0">Add Meetup Images</h5>
                            </div>
                            <form action="{{ route('admin.websitesetting.store') }}?type=meetup" method="POST"
