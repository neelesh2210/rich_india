                                                ...
                                                @isset($today_leaderboards[2])
                                                    <div class="box-right">
                                                        <a href="javascript:;" class="viewProfile">
                                                            ...
                                                            <h6 class="text-black fw-600 text-center mt-3 top-header"
                                                                style="font-size: 14px;">{{$today_leaderboards[2]->user->name}}</h6>
                                                ...
                                                @isset($last_week_leaderboards[2])
                                                    <div class="box-right">
                                                        <a href="javascript:;" class="viewProfile">
                                                            ...
                                                            <h6 class="text-black fw-600 text-center mt-3 top-header"
                                                                style="font-size: 14px;">{{$last_week_leaderboards[2]->user->name}}</h6>
                                                ...
                                                @isset($last_month_leaderboards[2])
                                                    <div class="box-right">
                                                        <a href="javascript:;" class="viewProfile">
                                                            ...
                                                            <h6 class="text-black fw-600 text-center mt-3 top-header"
                                                                style="font-size: 14px;">{{$last_month_leaderboards[2]->user->name}}</h6>
                                                ...
                                                @isset($all_time_leaderboards[2])
                                                    <div class="box-right">
                                                        <a href="javascript:;" class="viewProfile">
                                                            ...
                                                            <h6 class="text-black fw-600 text-center mt-3 top-header"
                                                                style="font-size: 14px;">{{$all_time_leaderboards[2]->user->name}}</h6>
