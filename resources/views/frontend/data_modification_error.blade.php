                    ...
                    <tr>
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px; background:#fff; border-radius:3px;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);padding:0 40px;">
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        <img src="{{asset('backend/img/cancel.gif')}}" title="logo" alt="check" style="height:100px;margin-bottom: 10px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:center;">
                                        <h1 style="color:#1e1e2d; font-weight:600; margin:0;font-size:22px;font-family:'Rubik',sans-serif;">Data Modification not Allowed!</h1><br>
                                ...
                                <tr>
                                    <td>
                                        <p style="text-align:center; font-size:22px">Your Order Is Cancelled.</p>
