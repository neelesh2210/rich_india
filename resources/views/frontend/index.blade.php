...
@section('content')
    ...
    <section class="courses-area section-pt-120 section-pb-90" data-background="{{ asset('frontend/assets/img/bg/courses_bg.jpg') }}">
        <div class="container">
                        ...
                        <div class="courses__nav">
                            <ul class="nav nav-tabs" id="courseTab" role="tablist">
                                ...
                                @foreach ($plans as $plan)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="{{$plan->slug}}" data-bs-toggle="tab" data-bs-target="#{{$plan->slug}}-pane" type="button" role="tab" aria-controls="{{$plan->slug}}-pane" aria-selected="false">
                                            {{$plan->title}}
                                        </button>
                                    </li>
                                @endforeach
            ...
            <div class="tab-content" id="courseTabContent">
                ...
                @foreach ($plans as $plan)
                    <div class="tab-pane fade" id="{{$plan->slug}}-pane" role="tabpanel" aria-labelledby="{{$plan->slug}}" tabindex="0">
                        <div class="swiper courses-swiper-active">
                            <div class="swiper-wrapper">
                                @php
                                    $plan_courses = App\Models\Admin\Course::where('delete_status','0')->where('status','1')->whereIn('id',$plan->course_ids)->withCount('topic')->get();
                                @endphp
                                        ...
                                        <div class="courses__item shine__animate-item">
                                            ...
                                            <div class="courses__item-content">
                                                <ul class="courses__item-meta list-wrap">
                                                    ...
                                                    <li class="avg-rating"><i class="fas fa-star"></i> ({{$plan_course->review}} Reviews)</li>
                                                </ul>
            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="newsletter__img-wrap">
                        ...
                        <img src="{{ asset('frontend/assets/img/others/newsletter_shape01.png') }}" alt="img" data-aos="fade-up" data-aos-delay="400">
    ...
    <section class="choose__area-four tg-motion-effects section-py-140" data-background="{{ asset('frontend/assets/img/bg/courses_bg.jpg') }}">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="choose__img-four">
                        <div class="left__side">
                            <img src="{{ asset('frontend/assets/img/others/h7_choose_img01.jpg') }}" alt="img" data-aos="fade-down" data-aos-delay="200">
                            <img src="{{ asset('frontend/assets/img/others/h7_choose_img02.jpg') }}" alt="img" data-aos="fade-up" data-aos-delay="200">
                        </div>
                        ...
                        <img src="{{ asset('frontend/assets/img/others/h7_choose_shape01.svg') }}" alt="shape" class="shape shape-one tg-motion-effects4">
                        <img src="{{ asset('frontend/assets/img/others/h7_choose_shape02.svg') }}" alt="shape" class="shape shape-two alltuchtopdown">
                        <img src="{{ asset('frontend/assets/img/others/h7_choose_shape03.svg') }}" alt="shape" class="shape shape-three tg-motion-effects7">
                    </div>
                </div>
                <div class="col-lg-6">
                                            ...
                                            <div class="testimonial__item-top">
                                                <div class="testimonial__author">
                                                    <div class="testimonial__author-thumb">
                                                        <img src="{{ asset('backend/img/reviews/'.$review->image) }}" alt="img">
                                                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="instructor__item-two tg-svg bg1">
                            <div class="instructor__thumb-two">
                                ...
                                <div class="shape-two">
                                    <span class="svg-icon" id="instructor-svg" data-svg-icon="{{ asset('frontend/assets/img/instructor/instructor_shape02.svg') }}"></span>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="instructor__item-two tg-svg bg2">
                            <div class="instructor__thumb-two">
                                ...
                                <div class="shape-two">
                                    <span class="svg-icon" id="instructor-svg-two" data-svg-icon="{{ asset('frontend/assets/img/instructor/instructor_shape02.svg') }}"></span>
                                </div>
                            </div>
                            <div class="instructor__content-two">
                                ...
                                @foreach ($faqs as $faq_key=>$faq)
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{$faq_key}}" aria-expanded="true" aria-controls="collapse{{$faq_key}}">
                                                {{$faq->title}}
                                            </button>
                                        </h2>
