                ...
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="courses__details-content">
                        ...
                        <div class="courses__details-meta">
                            <ul class="list-wrap">
                                <li class="author-two">
                                    <img src="{{ asset('frontend/assets/img/courses/course_author001.png') }}"
                                        alt="img">
                                    By
                                    <a href="#">Richind</a>
                                </li>
                                <li class="date"><i
                                        class="flaticon-calendar"></i>{{ $course->created_at->format('d/m/Y') }}</li>
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-wrap">
                                                @foreach ($course->topic as $topic_key => $topic)
                                                    <li
                                                        class="course-item @if ($topic_key == 0) open-item @endif">
                                                        <a @if ($topic_key == 0) href="{{ $topic->video_url }}" @else href="#" @endif
                                                            class="course-item-link @if ($topic_key == 0) popup-video @endif">
                                                            ...
                                                            <div class="course-item-meta">
                                                                ...
                                                                @else
                                                                    <span class="item-meta course-item-status">
                                                                        <img src="{{ asset('frontend/assets/img/icons/lock.svg') }}"
                                                                            alt="icon">
                                                                    </span>
                                                                @endif
                                                            </div>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="courses__details-sidebar">
                        ...
                        <div class="courses__information-wrap">
                            ...
                            <ul class="list-wrap">
                                <li>
                                    <img src="{{ asset('frontend/assets/img/icons/course_icon01.svg') }}" alt="img"
                                        class="injectable">
                                    Tag
                                    <span>{{ $course->tag }}</span>
                                </li>
                                <li>
                                    <img src="{{ asset('frontend/assets/img/icons/course_icon02.svg') }}" alt="img"
                                        class="injectable">
                                    Review
                                    <span>{{ $course->review }}</span>
                                </li>
                                <li>
                                    <img src="{{ asset('frontend/assets/img/icons/course_icon03.svg') }}" alt="img"
                                        class="injectable">
                                    Students
