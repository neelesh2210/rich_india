                ...
                <div class="col-md-8 col-12">
                    <div class="login-wrap-bg">
                        <div class="row justify-content-center">
                            <div class="col-lg-12 col-12 m-lg-auto" id="details_div">
                ...
                <div class="col-xl-4 wow fadeInRight" id="payment_detail" data-wow-delay="300ms">
                    <div class="course-details__sidebar">
                        <div class="course-details__sidebar__item">
                            <h3 class="course-details__sidebar__title">Plan Details</h3>
                            <ul class="course-details__sidebar__lists clerfix">
                                <li>Product:<span>Total</span></li>
                                <li>Basic:<span id="basic_amount">₹{{ $plan_detail->amount }}</span></li>
                                <li @if (!$referral_code) class="d-none" @endif>Discount Amount:<span id="discount_amount">₹{{ $plan_detail->amount - $plan_detail->discounted_price }}</span></li>
                                <li>Grand Total<span id="grand_total_amount">₹ @if ($referral_code) {{ $plan_detail->discounted_price }} @else {{ $plan_detail->amount }}@endif</span></li>
                            </ul>
                            <div>
                            ...
                            <button type="button" class="richind-btn richind-btn-second w-100" id="submitButton" onclick="submitForm()"><span class="richind-btn__curve"></span>Next<i class="icon-arrow"></i></button>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="about-btn mt-3 mb-3">
                                                    <div class="text-center">
                                                        <a href="#" id="place_order" class="richind-btn richind-btn-second w-100"><span class="richind-btn__curve" id="price"></span>Place Order<i class="icon-arrow"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#FaqAccordion" style="">
                                            <div class="accordion-body">
                                                ...
                                                <div class="text-center">
                                                    <a id="wallet_referrel_code_button" class="richind-btn richind-btn-second w-100" onclick="$('#wallet_referrel_code_form').submit()"><span class="richind-btn__curve"></span>Place Order<i class="icon-arrow"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
