                                ...
                                <div class="loginbox">
                                    ...
                                    <form role="form" id="registerForm">
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="first_name" id="first_name" value="{{old('first_name')}}" class="form-control" placeholder="Enter Your First Name..." required/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="last_name" id="last_name" value="{{old('last_name')}}" class="form-control" placeholder="Enter Your Last Name..." required/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="email" id="email" value="{{old('email')}}" class="form-control" placeholder="xyz@gmail.com" required/>
                                                        ...
                                                        @foreach ($plans as $key => $plan)
                                                            <div class="col-lg-2 col-12 col-sm-2">
                                                                <ul class="img-ul flex-center-xs">
                                                                    <li class="img-li">
                                                                        <label for="ContentPlaceHolder1_img_checkbox_{{$plan->title}}" class="custom-label">
                                                                            <img id="ContentPlaceHolder1_img{{$plan->title}}" src="{{ asset('backend/img/plan/' . $plan->image) }}" />
                                                                            <p class="text-center">{{$plan->title}} (₹ @if(!$referral_code) {{ $plan->amount }} @else {{ $plan->discounted_price }} @endif)</p>
                                                                        </label>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <div class="d-grid">
                                                <button type="button" class="btn btn-primary btn-start" id="submitButton" onclick="submitForm()">Place Order &nbsp; &nbsp;
                                                    <span class="@if(!$referral_code) d-none @endif final_price" id="discounted_price_span">₹ {{$plan_detail->discounted_price}}</span>
                                                    <span class="@if($referral_code) d-none @endif final_price" id="price_span">₹ {{$plan_detail->amount}}</span>
    ...
    {{-- <div class="register-area ptb-100">
        <div class="container">
            ...
            <div class="row"> --}}
                {{-- <div class="col-md-8 container justify-content-center">
                    <div class="accordion-item mb-10">
                        <button class="accordion-button collapsed">
                            Returning customer?
                            <a class="reg" data-bs-toggle="collapse" data-bs-target="#custlogin" aria-expanded="@if($errors->has('error')) show @else false @endif" aria-controls="collapseTwo"> Click here to login</a>
                        </button>
                        <div id="custlogin" class="accordion-collapse collapse @if($errors->has('error')) show @endif" data-bs-parent="#FaqAccordion">
                            <div class="accordion-body">
                                ...
                                <form action="{{route('login')}}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <button type="submit" class="default-btn2 mt-24">Login</button>
                                        </div>
                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                            <div class="remember-me-wrap">
                                                <p><a href="{{ route('forgot.password') }}">Lost your password?</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        @foreach ($plans as $key => $plan)
                            <div class="col-lg-4 col-sm-4 col-xs-6">
                                <a href="{{route('checkout')}}?slug={{$plan->slug}}">
                                    <div class="single-process-card with-box-shadow @if($plan_detail->id == $plan->id) single-process-card-actives @endif mb-3">
                                        <div class="icon">
                                            <img src="{{ asset('backend/img/plan/' . $plan->image) }}">
                                        </div>
                                        <h2>
                                            <a href="{{route('checkout')}}?slug={{$plan->slug}}">
                                                <input type="radio" name="radio" value="{{$plan->title}}" @if($plan_detail->id == $plan->id) checked @endif>
                                                {{ $plan->title }}
                                            </a>
                                        </h2>
                                        <strong>  <span>Rs. @if(!$referral_code) {{ $plan->amount }} @else {{ $plan->discounted_price }} @endif</span>
                                            <span>(Inc GST+18%)</span>
                                        </strong>
                                    </div>
                                 </a>
                    ...
                    <div class="your-order mb-30">
                        <div class="col-md-12">
                            <p>Pay by Credit Card/Debit Card/Net Banking/UPI</p>
                            <button type="button" class="default-btn w-100 disabled" id="submitButton" onclick="submitForm()">Place Order &nbsp; &nbsp;
                                <span class="@if(!$referral_code) d-none @endif final_price" id="discounted_price_span">₹ {{$plan_detail->discounted_price}}</span>
                                <span class="@if($referral_code) d-none @endif final_price" id="price_span">₹ {{$plan_detail->amount}}</span>
                                <span> (Inc GST+18%)</span>
                            </button>
                ...
                {{--<div class="col-md-4">
                     <div class="chekout-plan">
                        <div class="item">
                            <div class="plan"><strong> Product</strong>
                                <span class="reg"><strong class="text-dark"> Price </strong></span>
                            </div>
                        </div>
                        @foreach ($plans as $key => $plan)
                            <div class="item">
                                <a href="{{route('checkout')}}?slug={{$plan->slug}}">
                                    <div class="plan">
                                        <input type="radio" name="radio" value="{{$plan->title}}" @if($plan_detail->id == $plan->id) checked @endif>
                                        {{ $plan->title }}
                                        <span class="reg"> Rs. @if(!$referral_code) {{ $plan->amount }} @else {{ $plan->discounted_price }} @endif  </span>
                                    </div>
                                </a>
                            </div>
                        @endforeach
                    ...
                    <div class="your-order mt-30 mb-10">
                        <h3>Your order</h3>
                        <hr>
                        <div class="your-order-table table-responsive">
                            <table>
                                ...
                                <tbody>
                                    <tr class="cart_item">
                                        <td><b>{{$plan_detail->title}}</b></td>
                                        <td><span><b>₹{{$plan_detail->amount}}</b></span></td>
                                    </tr>
                                   ...
                                   {{-- @foreach ($plan_detail->course_ids as $course_id)
                                    ...
                                    <tr class="cart_item">
                                        <td>Subtotal</td>
                                        <td><span>₹{{$plan_detail->amount}}</span></td>
                                    </tr>

                                    <tr class="cart_item @if(!$referral_code) d-none @endif" id="discount_div">
                                        <td>Discount Amount</td>
                                        <td>
                                            <span>
                                                ₹ {{$plan_detail->amount - $plan_detail->discounted_price}}
                                            </span>
                                        </td>
                                    </tr>

                                    <tr class="cart_item d-none coupon_discount">
                                        <td>Coupon Discount</td>
                                        <td><span class="coupon_discount_amount"></span></td>
                                    </tr>
                    ...
                    <div class="accordion-item mb-30">
                        <button class="accordion-button collapsed">
                            Have a coupon?
                            <a class="reg" data-bs-toggle="collapse" data-bs-target="#couponcode" aria-expanded="false" aria-controls="collapseTwo"> Click here to enter your coupon
                                code
                            </a>
                        </button>
                        <div id="couponcode" class="accordion-collapse collapse" data-bs-parent="#FaqAccordion">
                            <div class="accordion-body">
                                <p>If you have a coupon code, please apply it below.</p>
                                <div class="coupon-code-btn">
                                    <i class="icon-coupon-3-line"></i>
                                    <input type="text" id="coupon" placeholder="Coupon Code">
                                    <button type="button" class="edu-btn btn-primary" onclick="checkCoupon()">Apply Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="your-order mb-30">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="default-btn w-100 disabled" id="submitButton" onclick="submitForm()">Place Order &nbsp; &nbsp;
                                <span class="@if(!$referral_code) d-none @endif final_price" id="discounted_price_span">₹ {{$plan_detail->discounted_price}}</span>
                                <span class="@if($referral_code) d-none @endif final_price" id="price_span">₹ {{$plan_detail->amount}}</span></button>
                        </div>
                    </div>
                </div> --}}
            {{-- </div>
