                        ...
                        <div class="terms-text">
                            <div class="col-md-12">
                                ...
                                <p>An anonymized string created from your email address (also called a hash) may be provided
                                    to the
                                    Gravatar service to see if you are using it. The Gravatar service privacy policy is
                                    available
                                    here: {{ env('APP_URL') }}. After approval of your comment, your profile picture is
                                    visible to
                                ...
                                <p>If you leave a comment on our site you may opt-in to saving your name, email address and
                                    website
                                    in cookies. These are for your convenience so that you do not have to fill in your
                                    details again
                                ...
                                <p>If you visit our login page, we will set a temporary cookie to determine if your browser
                                    accepts
                                    cookies. This cookie contains no personal data and is discarded when you close your
                                    browser.</p>
                                <p>When you log in, we will also set up several cookies to save your login information and
                                    ...
                                    for a
                                    year. If you select “Remember Me”, your login will persist for two weeks. If you log out
                                    of your
                                ...
                                <p>For users that register on our website (if any), we also store the personal information
                                    ...
                                    information at
                                    any time (except they cannot change their username). Website administrators can also see
                                    and
                                ...
                                <p>If you have an account on this site, or have left comments, you can request to receive an
                                    ...
                                    provided to
                                    us. You can also request that we erase any personal data we hold about you. This does
                                    not
